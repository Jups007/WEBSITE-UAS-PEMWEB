    ...
    <div class="d-flex flex-wrap gap-3">
        <div class="card" style="width: 250px;">
            <div class="card-body">
                ...
                <span class="fs-2 p-0 m-0"><?php echo e($totalProduct); ?></span>
            </div>
        </div>
        <div class="card" style="width: 250px;">
            <div class="card-body">
                ...
                <span class="fs-2 p-0 m-0"><?php echo e($sumStock); ?></span>
            </div>
        </div>
        <div class="card" style="width: 250px;">
            <div class="card-body">
                ...
                <span class="fs-2 p-0 m-0"><?php echo e($dataTransaksi); ?></span>
            </div>
        </div>
        <div class="card" style="width: 250px;">
            <div class="card-body">
                ...
                <span class="fs-2 p-0 m-0"><?php echo e(number_format($dataPenghasilan / 1000000, 2) . ' Jt'); ?></span>
            </div>
        </div>
    </div>
