    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('storePelanggan')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3 row">
...
</script><?php /**PATH C:\Users\juan\WebsiteUAS\resources\views/pelanggan/modal/registerPelanggan.blade.php ENDPATH**/ ?>