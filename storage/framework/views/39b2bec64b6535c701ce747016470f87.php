                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="celana" <?php echo e($data->type === 'celana' ? 'selected' : ''); ?>>Celana</option>
                                <option value="baju" <?php echo e($data->type === 'baju' ? 'selected' : ''); ?>>Baju</option>
                                <option value="aksesoris" <?php echo e($data->type === 'aksesoris' ? 'selected' : ''); ?>>Aksesoris
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Pria" <?php echo e($data->kategory === 'Pria' ? 'selected' : ''); ?>>Pria</option>
                                <option value="Wanita" <?php echo e($data->kategory === 'wanita' ? 'selected' : ''); ?>>Wanita
                                </option>
                                <option value="Anak-anak" <?php echo e($data->kategory === 'Anak-anak' ? 'selected' : ''); ?>>
                                    Anak-anak</option>
                            </select>
                        </div>
                    </div>
...
</script><?php /**PATH C:\Users\juan\WebsiteUAS\resources\views/admin/modal/editModal.blade.php ENDPATH**/ ?>