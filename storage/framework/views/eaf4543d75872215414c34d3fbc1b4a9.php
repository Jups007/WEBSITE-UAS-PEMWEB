<aside
    ...
    <div class="collapse navbar-collapse flex-grow-0" id="navbarNavDropdown">
        <ul class="navbar-nav flex-column gap-3 px-2">
            ...
            <li class="navbar-item rounded <?php echo e(Request::path() === 'admin/report' ? 'bg-info' : ''); ?> ">
                <a href="report" class="">
                    <div class="d-flex gap-3">
...
</aside><?php /**PATH C:\Users\juan\WebsiteUAS\resources\views/admin/components/sidebar.blade.php ENDPATH**/ ?>