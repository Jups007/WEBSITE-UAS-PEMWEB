...
<?php $__env->startSection('content'); ?>
    <div class="row mt-4 align-items-center">
        ...
        <div class="col-md-6">
            <img src="<?php echo e(asset('assets/images/office-2.png')); ?>" style="width:100%" alt="">
        </div>
    </div>
...
<?php echo $__env->make('pelanggan.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\juan\WebsiteUAS\resources\views/pelanggan/page/contact.blade.php ENDPATH**/ ?>